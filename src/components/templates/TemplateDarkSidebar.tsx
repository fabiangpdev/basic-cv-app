...
export function TemplateDarkSidebar({ data, lang }: { data: ReturnType<typeof useResumeStore.getState>['resumeData']; lang: Language }) {
      ...
      <div className="w-[30%] bg-slate-800 text-white p-5 flex-shrink-0 rounded-r-xl overflow-hidden">
        ...
        <div className="space-y-3 text-[9px] text-slate-300">
          ...
          {data.personalInfo.phone && (
            <div>
              <p className="text-slate-500 text-[8px] uppercase mb-0.5">{L.phone}</p>
              <p>{data.personalInfo.phone}</p>
            </div>
          )}
          {data.personalInfo.location && (
            <div>
              <p className="text-slate-500 text-[8px] uppercase mb-0.5">{L.location}</p>
        ...
        {data.skills.length > 0 && (
          <div className="mt-6">
            <h3 className="text-[10px] font-bold uppercase text-slate-400 mb-3">{L.skills}</h3>
      ...
      <div className="flex-1 p-6 overflow-hidden">
        {data.personalInfo.summary && (
          <section className="mb-6">
            <h2 className="text-[12px] font-bold uppercase text-slate-800 border-b border-slate-300 pb-1 mb-3">{L.summary}</h2>
        ...
        {data.experiences.length > 0 && (
          <section className="mb-6">
            <h2 className="text-[12px] font-bold uppercase text-slate-800 border-b border-slate-300 pb-1 mb-3">{L.experience}</h2>
        ...
        {data.education.length > 0 && (
          <section className="mb-6">
            <h2 className="text-[12px] font-bold uppercase text-slate-800 border-b border-slate-300 pb-1 mb-3">{L.education}</h2>
        ...
        {data.projects.length > 0 && (
          <section>
            <h2 className="text-[12px] font-bold uppercase text-slate-800 border-b border-slate-300 pb-1 mb-3">{L.projects}</h2>
            <div className="space-y-4">
