...
export function TemplateModern({ data, lang }: { data: ReturnType<typeof useResumeStore.getState>['resumeData']; lang: Language }) {
    ...
    <div className="bg-white min-h-[842px] flex text-[10px]">
      <div className="w-[28%] bg-slate-900 text-white p-6">
        ...
        <div className="space-y-6">
          <div>
            <p className="text-[9px] uppercase tracking-wider text-slate-400 mb-3">{L.contact}</p>
          ...
          {data.skills.length > 0 && (
            <div>
              <p className="text-[9px] uppercase tracking-wider text-slate-400 mb-3">{L.skills}</p>
      ...
      <div className="w-[72%] p-6 text-slate-900">
        ...
        {data.experiences.length > 0 && (
          <section className="mb-6">
            <h3 className="text-[11px] font-bold uppercase tracking-wide mb-3 text-slate-800">{L.experience}</h3>
        ...
        {data.education.length > 0 && (
          <section className="mb-6">
            <h3 className="text-[11px] font-bold uppercase tracking-wide mb-3 text-slate-800">{L.education}</h3>
        ...
        {data.projects.length > 0 && (
          <section>
            <h3 className="text-[11px] font-bold uppercase tracking-wide mb-3 text-slate-800">{L.projects}</h3>
            <div className="space-y-4">
