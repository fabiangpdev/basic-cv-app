...
export const testResumeData: ResumeData = {
  ...
  skills: [
    ...
    { id: '3', name: 'React', level: 'advanced', category: 'technical' },
    { id: '4', name: 'Node.js', level: 'advanced', category: 'technical' },
    { id: '5', name: 'Python', level: 'intermediate', category: 'technical' },
    { id: '6', name: 'PostgreSQL', level: 'intermediate', category: 'technical' },
    { id: '7', name: 'MongoDB', level: 'intermediate', category: 'technical' },
    { id: '8', name: 'Git', level: 'advanced', category: 'tool' },
    { id: '9', name: 'AWS', level: 'intermediate', category: 'tool' },
    { id: '10', name: 'Docker', level: 'intermediate', category: 'tool' },
  ],
  certifications: [
    {
      id: '1',
